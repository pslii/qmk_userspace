 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LALT | LCTL |Space | /LOWER  /       \RAISE \  |Enter | Bspc | RALT | RGUI |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_QWERTY] = LAYOUT(
    ...
    KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    KC_MUTE,   KC_MPLY,KC_N,     KC_M,     KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                      KC_LGUI, KC_LALT, KC_LCTL, KC_SPC,  TL_LOWR,   TL_UPPR,KC_ENT,   KC_BSPC,  KC_RALT, KC_RGUI
),
/* LOWER - Nav
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      | Ins  |      |Opt-C |Ctrl-R|Ctrl-T|                    | PgUp | PWrd |  Up  | NWrd |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      | LAlt | LCtl |LShift| Del  | Caps |-------.    ,-------| PgDn | Left | Down | Right|      |      |
 * |------+------+------+------+------+------| Back  |    | Fwd   |------+------+------+------+------+------|
...
[_LOWER] = LAYOUT(
    ...
    _______, KC_INS,  XXXXXXX, LALT(KC_C), LGUI(KC_R), LGUI(KC_T),                 KC_PGUP, KC_PRVWD,  KC_UP,   KC_NXTWD,  XXXXXXX,  XXXXXXX,
    KC_CAPS, KC_LALT, KC_LCTL, KC_LSFT, MO(_DEL), XXXXXXX,                         KC_PGDN, KC_LEFT,   KC_DOWN, KC_RGHT,   XXXXXXX,  XXXXXXX,
...
[_RAISE] = LAYOUT(
    ...
    KC_GRV,  KC_EXLM, KC_LCBR, KC_DQUO, KC_RCBR, KC_QUES,                         KC_AMPR, KC_LBRC, KC_COMM, KC_RBRC, KC_HASH, KC_BSPC,
    KC_MINS, KC_BSLS, KC_LPRN, KC_UNDS, KC_RPRN, KC_QUOT,                         KC_PIPE, KC_COLN, KC_DOT,  KC_SCLN, KC_CIRC, XXXXXXX,
    XXXXXXX, KC_TILD, KC_LT,   KC_EQL,  KC_GT,   KC_SLSH, _______,       _______, KC_PLUS, KC_ASTR, KC_DLR,  KC_AT,   KC_PERC, XXXXXXX,
                      _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______
),
/* ADJUST - Adjust
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_ADJUST] = LAYOUT(
    ...
    XXXXXXX, RGB_SPI, RGB_VAI, RGB_SAI, RGB_HUI, RGB_MODE_FORWARD,              KC_BRIU, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
